...
{
   //Book* book = new Book(categoryID(), prodName_, price_, 
   //qty_, isbn_, author_);
   Product* book = new Book(categoryID(), prodName_, price_, 
   qty_, isbn_, author_);
...
{
   //Clothing* clothing = new Clothing(categoryID(), prodName_, price_, 
   //qty_, size_, brand_);
   Product* clothing = new Clothing(categoryID(), prodName_, price_, 
   qty_, size_, brand_);
...
{
   //Movie* movie = new Movie(categoryID(), prodName_, price_, 
   //qty_, genre_, rating_);
   Product* movie = new Movie(categoryID(), prodName_, price_, 
   qty_, genre_, rating_);
